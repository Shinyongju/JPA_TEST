...
@NamedQuery(
      ...
      query = "select w from Wbs_2020 w where w.u_no = :u_no order by date"
      )
...
//@Entity
//@Table(name = "wbs_2020")
//@NamedQuery(name = "Wbs_2020.findWbs", query = "select u from Wbs_2020 u where u.u_no = :id")
//public class Wbs_2020 {
//
//	@Id
//	private int no;
...
//	@Override
//	public String toString() {
//		return "Wbs_2020 [no=" + no + ", id=" + u_no + ", date=" + date + ", start_time=" + start_time + ", end_time="
//				+ end_time + ", rest_time=" + rest_time + ", vacation_type=" + vacation_type + ", vacation_type="
//				+ vacation_type + ", memo=" + memo + ", reg_date=" + reg_date + ", upd_date=" + upd_date + "]";
//	}
//
//}