...
public class User_Info {
	...
	public String toString() {
		return "User_info [no=" + no + ", id=" + u_no + ", password=" + u_password + ", name=" + name + ", gender="
				+ gender + ", address=" + address + ", mobile_number=" + mobile_number + ", birth_day=" + birth_day
				+ ", hire_date=" + hire_date + ", reg_date=" + reg_date + ", upd_date=" + upd_date + ", upd_user="
				+ upd_user + "]";
	}
