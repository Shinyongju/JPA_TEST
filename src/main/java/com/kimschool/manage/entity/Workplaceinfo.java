...
@Table(name="workplaceinfo")
	@NamedQuery(
	        name = "Workplaceinfo.findByWbs",
	        query = "select u from Workplaceinfo u where u.u_no = :id")
public class Workplaceinfo {
   ...
   private String reg_date;
	...
	public String toString() {
		return "Workplaceinfo [no=" + no + ", id=" + u_no + ", wp_name=" + wp_name + ", min_time=" + min_time + ", max_time="
