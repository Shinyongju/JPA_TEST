...
<body>
	...
	<h3>근무시간 :
		${((resultB.get(0).end_time-resultB.get(0).start_time-resultB.get(0).rest_time)+(resultB.get(1).end_time-resultB.get(1).start_time-resultB.get(1).rest_time))/100}</h3>
	...
	<table border="1">
		...
		<tr>
			...
			<td><c:if test="${resultB.get(0).vacation_type == 0 }">
	      	출근
   	  	</c:if> <c:if test="${resultB.get(0).vacation_type == 1 }">
	      	휴무
   	  	</c:if></td>
			<td>${resultB.get(0).start_time}</td>
			<td>${resultB.get(0).end_time}</td>
			<td>${resultB.get(0).rest_time}</td>
			<td><c:if test="${resultB.get(0).end_time != 0 }">
		...
		<tr>
			...
			<td><c:if test="${resultB.get(1).vacation_type == 0 }">
	      	출근
   	  	</c:if> <c:if test="${resultB.get(1).vacation_type == 1 }">
	      	휴무
   	  	</c:if></td>
			<td>${resultB.get(1).start_time}</td>
			<td>${resultB.get(1).end_time}</td>
			<td>${resultB.get(1).rest_time}</td>
			<td><c:if test="${resultB.get(1).end_time != 0 }">
